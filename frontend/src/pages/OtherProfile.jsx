...
const OtherProfile = () => {
  const { profileUser, isUpdatingProfile } = useAuthStore();
        ...
        <div className="w-full relative">
          <div className="w-full h-[24vh] rounded-2xl bg-red-500 overflow-hidden">
            <img
              ...
              src="https://i.pinimg.com/736x/2f/51/4f/2f514f2e315e6ded94f43a28ae4b01a3.jpg"
              alt=""
            />
            <div className="w-[22vw] h-[22vw] border-4 rounded-full border-white absolute -bottom-15 left-[50%] -translate-x-[50%] bg-red-500 overflow-hidden ">
              <img
                ...
                src={
                  ...
                  "https://i.pinimg.com/736x/37/99/40/37994074659781fe22baafe145667e24.jpg"
                }
                alt=""
              />
            </div>
        ...
        {isUpdatingProfile ? (
          <div className="flex flex-col justify-start w-full mt-5 ">
            ...
            <p className="w-full text-gray-600">
              ...
              suscipit ullam recusandae libero! Distinctio cum repudiandae quas
              fugit, impedit recusandae quasi fuga optio delectus corporis
              veniam eaque quae necessitatibus.
            </p>
          </div>
        ) : (
          <Link to="/update">
            <div className="w-full bg-[#A975FF] rounded-xl cursor-pointer p-3 text-center mt-5 text-white font-medium ">
              Edit Profile
            </div>
          </Link>
        )}
